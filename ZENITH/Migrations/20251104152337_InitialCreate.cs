        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "select"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentSportId = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sports_Sports_ParentSportId",
                        column: x => x.ParentSportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportCategories", x => new { x.SportId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_SportCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SportCategories_Sports_SportId",
                        column: x => x.SportId,
                        principalTable: "Sports",
                        principalColumn: "SportId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_ProductVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "VariantId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_VariantId",
                table: "Favorites",
                columns: new[] { "UserId", "VariantId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_VariantId",
                table: "Favorites",
                column: "VariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_OrderStatus_PaymentStatus",
                table: "Orders",
                columns: new[] { "OrderStatus", "PaymentStatus" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_IsActive_Price",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SportCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sports_ParentSportId",
                table: "Sports",
                column: "ParentSportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantAttributeValues_VariantId_ValueId",
                table: "VariantAttributeValues",
